...
from eolab.geo-rastertools import rastertools
...
class TestCase:
    ...
    def __repr__(self):
        return (f"geo-rastertools {' '.join(self._args)}"
...
def test_radioindice_command_line_errors(caplog):
    ...
    logslist = [
        [],
        [("eolab.geo-rastertools.cli.radioindice", logging.ERROR, "Invalid indice name: strange")],
        [("eolab.geo-rastertools.cli.utils_cli", logging.ERROR,
        ...
        [("eolab.geo-rastertools.geo-rastertools", logging.ERROR,
          "Output directory \"./toto\" does not exist.")],
        [("eolab.geo-rastertools.cli.radioindice", logging.ERROR,
...
def test_timeseries_command_line_errors(caplog):
    ...
    logslist = [
        ...
        [("eolab.geo-rastertools.cli.timeseries", logging.ERROR,
...
def test_zonalstats_command_line_errors():
    ...
    logslist = [
        [("eolab.geo-rastertools.main", logging.ERROR,
          "Output directory \"./toto\" does not exist.")],
        [("eolab.geo-rastertools.main", logging.ERROR,
...
def test_tiling_command_line_special_case(caplog):
    ...
    # expected logs
    logslist = [
        [("eolab.geo-rastertools.tiling", logging.ERROR,
