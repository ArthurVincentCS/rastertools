...
import logging
from eolab.geo-rastertools import Radioindice
from eolab.geo-rastertools.processing.rasterproc import RadioindiceProcessing
from eolab.geo-rastertools.product.rastertype import BandChannel
...
def test_radioindice_incompatible_indice_rastertype(caplog):
    ...
    exp_log = ("eolab.geo-rastertools.radioindice", logging.ERROR,
