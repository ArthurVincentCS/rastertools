...
from eolab.geo-rastertools.product.rastertype import Band, BandChannel, RasterType
from eolab.geo-rastertools.product.rasterproduct import RasterProduct
...
RasterType.add(json.load(importlib.resources.open_binary("eolab.geo-rastertools.product", "rastertypes.json")))
