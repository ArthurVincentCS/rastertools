...
class RasterType:
    ...
    def find(file: Union[Path, str]):
        ...
        Returns:
            :obj:`eolab.geo-rastertools.product.RasterType`: the RasterType corresponding
            to the input file
        """
    ...
    def channels(self) -> List[BandChannel]:
        ...
        Returns:
            [:obj:`eolab.geo-rastertools.product.BandChannel`]:
    ...
    def has_channel(self, channel: BandChannel) -> bool:
        ...
        Args:
            channel (:obj:`eolab.geo-rastertools.product.BandChannel`):
                Band channel
