...
"""
from eolab.geo-rastertools import Filtering
from eolab.geo-rastertools.cli.utils_cli import apply_process, pad_opt, win_opt, all_opt, band_opt
import click
import os
...
def create_filtering(output : str, window_size : int, pad : str, argsdict : dict, filter : str, bands : list, kernel_size : int, all_bands : bool) -> Filtering:
    ...
    Returns:
        :obj:`eolab.geo-rastertools.Filtering`: A configured `Filtering` instance ready for execution.
    """
