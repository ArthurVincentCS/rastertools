...
from eolab.geo-rastertools import RastertoolConfigurationException, Radioindice
from eolab.geo-rastertools.cli.utils_cli import apply_process, win_opt
from eolab.geo-rastertools.product import BandChannel
...
@click.option('-nd', '--normalized_difference','nd',type=str,
    multiple=True, nargs=2, metavar="band1 band2",
              help="Compute the normalized difference of two bands defined"
                        ...
                        "See eolab.geo-rastertools.product.rastertype.BandChannel for the list of bands names. "
