...
from eolab.geo-rastertools.processing import RasterFilter, compute_sliding
...
class Filtering(Rastertool, Windowable):
    ...
    :obj:`eolab.geo-rastertools.processing.RasterFilter`).
    ...
    def get_default_filters():
        ...
        Returns:
            [:obj:`eolab.geo-rastertools.processing.RasterFilter`] List of the predefined
    ...
    def __init__(self, raster_filter: RasterFilter, kernel_size: int, bands: List[int] = [1]):
        ...
        Args:
            raster_filter (:obj:`eolab.geo-rastertools.processing.RasterFilter`):
    ...
    def with_filter_configuration(self, argsdict: Dict):
        ...
        Returns:
            :obj:`eolab.geo-rastertools.Filtering`: The current instance so that it is
