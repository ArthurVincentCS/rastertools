...
from eolab.geo-rastertools.utils import get_metadata_name
from eolab.geo-rastertools.processing.vector import rasterize, filter_dissolve
...
def compute_zonal_stats(geoms: gpd.GeoDataFrame, image: str,
    ...
    Example:
        ```
        import geopandas as gpd
        from geo-rastertools import compute_zonal_stats
...
def compute_zonal_stats_per_category(geoms: gpd.GeoDataFrame, image: str,
    ...
    Example:
        ```
        import geopandas as gpd
        from geo-rastertools import compute_zonal_stats_per_category
