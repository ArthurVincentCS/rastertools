...
from eolab.geo-rastertools import Rastertool, Windowable
from eolab.geo-rastertools.processing import algo
from eolab.geo-rastertools.processing import RadioindiceProcessing
from eolab.geo-rastertools.product import BandChannel, RasterProduct
...
class Radioindice(Rastertool, Windowable):
    ...
    :obj:`eolab.geo-rastertools.processing.RadioindiceProcessing`
    ...
    def get_default_indices():
        ...
        Returns:
            [:obj:`eolab.geo-rastertools.processing.RadioindiceProcessing`]: list of
    ...
    def __init__(self, indices: List[RadioindiceProcessing]):
        ...
        Args:
            indices ([:obj:`eolab.geo-rastertools.processing.RadioindiceProcessing`]):
    ...
    def with_output(self, outputdir: str = ".", merge: bool = False):
        ...
        Returns:
            :obj:`eolab.geo-rastertools.Radioindice`: The current instance so that it is
...
def compute_indices(input_image: str, image_channels: List[BandChannel],
    ...
    Args:
        ...
        image_channels ([:obj:`eolab.geo-rastertools.product.BandChannel`]):
