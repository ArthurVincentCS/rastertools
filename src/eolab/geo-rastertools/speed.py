...
from eolab.geo-rastertools import Rastertool
...
def compute_speed(date0: datetime, date1: datetime,
    ...
    Args:
        ...
        product0 (:obj:`eolab.geo-rastertools.product.RasterProduct`):
            Path of the first raster image
        product1 (:obj:`eolab.geo-rastertools.product.RasterProduct`):
