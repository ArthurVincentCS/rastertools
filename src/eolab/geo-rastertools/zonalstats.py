...
from eolab.geo-rastertools import Rastertool, RastertoolConfigurationException
from eolab.geo-rastertools.processing import compute_zonal_stats, compute_zonal_stats_per_category
from eolab.geo-rastertools.processing import extract_zonal_outliers, plot_stats
from eolab.geo-rastertools.processing import vector
...
class Zonalstats(Rastertool):
    ...
    def with_output(self, outputdir: str = ".", output_format: str = "ESRI Shapefile"):
        ...
        Returns:
            :obj:`eolab.geo-rastertools.Zonalstats`: the current instance so that it is
