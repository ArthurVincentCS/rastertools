...
# -*- coding: utf-8 -*-
"""
This module defines the base class for every Rastertool, namely :obj:`eolab.geo-rastertools.Rastertool`.
...
features. For example, the class :obj:`eolab.geo-rastertools.Windowable` enables to configure a
...
class Rastertool(ABC):
    ...
    def with_output(self, outputdir: str = "."):
        ...
        Returns:
            :obj:`eolab.geo-rastertools.Rastertool`: The current instance so that it is
...
class Windowable:
    """Decorator of a :obj:`eolab.geo-rastertools.Rastertool` that adds configuration
